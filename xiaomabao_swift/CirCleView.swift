...
class CirCleView: UIView, UIScrollViewDelegate {
    ...
    private func setScrollViewOfImage(){
        self.currentImageView.sd_setImageWithURL(NSURL(string:self.imageArray[self.indexOfCurrentImage] ), placeholderImage: UIImage.init(named: "placeholder_num1"))

        self.nextImageView.sd_setImageWithURL(NSURL(string: self.imageArray[self.getNextImageIndex(indexOfCurrentImage: self.indexOfCurrentImage)]), placeholderImage: UIImage.init(named: "placeholder_num1"))
        self.lastImageView.sd_setImageWithURL(NSURL(string: self.imageArray[self.getLastImageIndex(indexOfCurrentImage: self.indexOfCurrentImage)]), placeholderImage: UIImage.init(named: "placeholder_num1"))
    }
